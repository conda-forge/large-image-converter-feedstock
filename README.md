...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/large-image-converter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14748&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/large-image-converter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `large-image-converter` can be installed with:

```
conda install large-image-converter
```

It is possible to list all of the versions of `large-image-converter` available on your platform with:
